    ...
    <div class="row g-4">
        ...
        <div class="col-lg-5">
            ...
            <div class="paket-card h-100">
                <h3 class="text-muted">Gratis</h3>
                <div class="harga">Rp 0 <sub class="fw-normal">/ selamanya</sub></div>
                <hr>
                <ul class="my-4">
                    <li><i class="bi bi-check-circle-fill"></i> Posting Lowongan (Terbatas)</li>
                    <li><i class="bi bi-check-circle-fill"></i> Menerima Lamaran</li>
                    <li><i class="bi bi-x-circle-fill text-muted"></i> Akses Talent Pool Premium</li>
                    <li><i class="bi bi-x-circle-fill text-muted"></i> Undang Kandidat</li>
                </ul>
                <button class="btn btn-secondary w-100 mt-auto" disabled>Paket Anda Saat Ini</button>
            </div>
        </div>
    </div>
@endif

...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2025 at 10:53 PM
...
(69, NULL, 'Pendaftaran Pelamar', 'akmal mendaftar sebagai pelamar baru.', '2025-09-18 00:38:10', '2025-09-18 00:38:10'),
(70, 80, 'Pendaftaran Pelamar', 'duti mendaftar sebagai pelamar baru.', '2025-09-18 00:42:43', '2025-09-18 00:42:43'),
(71, NULL, 'Pendaftaran Pelamar', 'ram mendaftar sebagai pelamar baru.', '2025-11-23 21:31:09', '2025-11-23 21:31:09'),
(72, NULL, 'Pendaftaran Pelamar', 'lali mendaftar sebagai pelamar baru.', '2025-11-23 22:42:09', '2025-11-23 22:42:09'),
(73, NULL, 'Pendaftaran Pelamar', 'lali mendaftar sebagai pelamar baru.', '2025-11-23 22:47:41', '2025-11-23 22:47:41'),
(74, 84, 'Pendaftaran Pelamar', 'pppp mendaftar sebagai pelamar baru.', '2025-11-24 00:15:04', '2025-11-24 00:15:04'),
(75, 86, 'Pendaftaran Perusahaan', 'PT. DutaAbadi mendaftar sebagai perusahaan baru.', '2025-11-26 13:23:50', '2025-11-26 13:23:50');
...
('admin1@messari.com|127.0.0.1', 'i:3;', 1763961334),
('admin1@messari.com|127.0.0.1:timer', 'i:1763961334;', 1763961334);
...
--
-- Table structure for table `form_isian_interview`
--

CREATE TABLE `form_isian_interview` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `jadwal_id` bigint(20) UNSIGNED NOT NULL,
  `pelamar_id` bigint(20) UNSIGNED NOT NULL,
  `catatan_interviewer` text DEFAULT NULL COMMENT 'Catatan evaluasi yang diisi oleh Admin/Perusahaan.',
  `nilai_kandidat` varchar(255) DEFAULT NULL COMMENT 'Nilai skor atau grade kandidat.',
  `rekomendasi` enum('Lolos','Tolak','Pertimbangkan') NOT NULL DEFAULT 'Pertimbangkan',
  `data_tambahan_pelamar` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Jawaban survei/isian dari pelamar dalam format JSON.' CHECK (json_valid(`data_tambahan_pelamar`)),
  `tanggal_diisi` timestamp NULL DEFAULT NULL COMMENT 'Waktu pelamar selesai mengisi formulir.',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 7, 'Lowongan Besar-Besaran IT Support', 'Kami mencari talenta terbaik untuk bergabung.', 'vip', 'aktif', 'iklan_banners/banner_vip_1.jpg', NULL, NULL, NULL, '2025-11-25 12:59:43', '2025-12-25 12:59:43', '2025-11-25 12:59:43', '2025-11-25 12:59:43'),
(2, 12, 'Dicari: Senior Akuntan', 'Bergabunglah dengan tim finansial terbaik kami.', 'vip', 'aktif', 'iklan_banners/banner_vip_2.jpg', NULL, NULL, NULL, '2025-11-25 12:59:43', '2025-12-25 12:59:43', '2025-11-25 12:59:43', '2025-11-25 12:59:43'),
(3, 2, 'Telkom Digital Talent', 'Membangun masa depan digital Indonesia.', 'vip', 'aktif', 'iklan_banners/banner_vip_3.jpg', NULL, NULL, NULL, '2025-11-25 12:59:43', '2025-12-25 12:59:43', '2025-11-25 12:59:43', '2025-11-25 12:59:43'),
(4, 5, 'Open Recruitment Staff Admin', 'Dibutuhkan segera.', 'gratis', 'aktif', 'iklan_banners/banner_gratis_1.jpg', NULL, NULL, NULL, '2025-11-25 12:59:43', '2025-12-25 12:59:43', '2025-11-25 12:59:43', '2025-11-25 12:59:43'),
(5, 6, 'Hiring: Marketing Executive', 'Komisi menarik menanti anda.', 'gratis', 'aktif', 'iklan_banners/banner_gratis_2.jpg', NULL, NULL, NULL, '2025-11-25 12:59:43', '2025-12-25 12:59:43', '2025-11-25 12:59:43', '2025-11-25 12:59:43'),
(6, 9, 'Teknisi Jaringan Dibutuhkan', 'Penempatan area Semarang.', 'gratis', 'aktif', 'iklan_banners/banner_gratis_3.jpg', NULL, NULL, NULL, '2025-11-25 12:59:43', '2025-12-25 12:59:43', '2025-11-25 12:59:43', '2025-11-25 12:59:43'),
(7, 8, 'Lowongan Kasir & Pramuniaga', 'Syarat mudah, langsung kerja.', 'gratis', 'aktif', 'iklan_banners/banner_gratis_4.jpg', NULL, NULL, NULL, '2025-11-25 12:59:43', '2025-12-25 12:59:43', '2025-11-25 12:59:43', '2025-11-25 12:59:43'),
(8, 5, 'Staff Gudang & Logistik', 'Penempatan Jakarta, pengalaman min 1 tahun.', 'gratis', 'aktif', 'iklan_banners/banner_gratis_5.jpg', NULL, NULL, NULL, '2025-11-25 13:27:50', '2025-12-25 13:27:50', '2025-11-25 13:27:50', '2025-11-25 13:27:50'),
(9, 6, 'Customer Service Representative', 'Ramah, komunikatif, shift kerja.', 'gratis', 'aktif', 'iklan_banners/banner_gratis_6.jpg', NULL, NULL, NULL, '2025-11-25 13:27:50', '2025-12-25 13:27:50', '2025-11-25 13:27:50', '2025-11-25 13:27:50'),
(10, 9, 'Junior Graphic Designer', 'Kreatif, menguasai Adobe Suite.', 'gratis', 'aktif', 'iklan_banners/banner_gratis_7.jpg', NULL, NULL, NULL, '2025-11-25 13:27:50', '2025-12-25 13:27:50', '2025-11-25 13:27:50', '2025-11-25 13:27:50'),
(11, 8, 'Driver Operasional Kantor', 'Memiliki SIM A/B1, paham jalan.', 'gratis', 'aktif', 'iklan_banners/banner_gratis_8.jpg', NULL, NULL, NULL, '2025-11-25 13:27:50', '2025-12-25 13:27:50', '2025-11-25 13:27:50', '2025-11-25 13:27:50'),
(12, 7, 'Admin Social Media', 'Aktif di sosmed, bisa copywriting dasar.', 'gratis', 'aktif', 'iklan_banners/banner_gratis_9.jpg', NULL, NULL, NULL, '2025-11-25 13:27:50', '2025-12-25 13:27:50', '2025-11-25 13:27:50', '2025-11-25 13:27:50'),
(13, 12, 'Freelance Content Writer', 'Menulis artikel SEO friendly, WFH.', 'gratis', 'aktif', 'iklan_banners/banner_gratis_10.jpg', NULL, NULL, NULL, '2025-11-25 13:27:50', '2025-12-25 13:27:50', '2025-11-25 13:27:50', '2025-11-25 13:27:50');
...
CREATE TABLE `jadwal_wawancara` (
  ...
  `form_status` enum('Belum Diisi','Terkirim','Sudah Diisi','Ditolak') NOT NULL DEFAULT 'Belum Diisi',
...
INSERT INTO `jadwal_wawancara` (`id`, `lowongan_id`, `pelamar_id`, `metode_wawancara`, `lokasi_interview`, `link_zoom`, `tanggal_interview`, `waktu_interview`, `deskripsi`, `status`, `form_status`, `form_submission_id`, `form_token`, `token_expires_at`, `created_at`, `updated_at`) VALUES
(1, 5, 38, 'Walk In Interview', 'pandansari', NULL, '2025-08-15', '03:56:00', 'gass', 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-08-07 13:58:07', '2025-09-25 00:57:22'),
(4, 8, 51, 'Walk In Interview', 'Demak Center', NULL, '2025-08-30', '01:36:00', NULL, 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-08-21 11:32:15', '2025-09-25 00:57:38'),
(5, 5, 51, 'Virtual Interview', NULL, 'https://us05web.zoom.us/j/84199507259?pwd=wtXDnr6EFXOyCsrPYc1ffhMTaNhGSW.1', '2025-09-29', '08:47:00', NULL, 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-09-25 00:49:41', '2025-09-25 00:49:41'),
(6, 5, 55, 'Virtual Interview', NULL, 'https://us05web.zoom.us/j/84199507259?pwd=wtXDnr6EFXOyCsrPYc1ffhMTaNhGSW.1', '2025-10-10', '03:47:00', NULL, 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-09-25 09:43:42', '2025-09-25 09:43:42'),
(7, 11, 50, 'Walk In Interview', 'Sungai AMAZON', NULL, '2025-10-03', '06:30:00', NULL, 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-09-25 11:15:46', '2025-09-25 11:45:41'),
(8, 8, 53, 'Walk In Interview', 'hotel capsul', NULL, '2025-09-30', '02:08:00', NULL, 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-09-26 09:05:59', '2025-09-26 09:05:59'),
(9, 15, 51, 'Virtual Interview', NULL, 'https://us05web.zoom.us/j/84199507259?pwd=wtXDnr6EFXOyCsrPYc1ffhMTaNhGSW.1', '2025-11-01', '03:57:00', NULL, 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-10-29 01:54:58', '2025-10-29 01:54:58'),
(10, 9, 55, 'Walk In Interview', 'lamongan', NULL, '2025-11-14', '05:15:00', NULL, 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-11-10 11:11:52', '2025-11-10 11:11:52'),
(11, 10, 10, 'Walk In Interview', 'lamongan', NULL, '2025-11-28', '14:24:00', NULL, 'terjadwal', 'Terkirim', NULL, 'Z9PFxUosCQrzjpaL6NAcIMXK4bTvYh8TMKD84WE7', '2025-12-01 02:34:13', '2025-11-23 21:24:58', '2025-11-24 02:34:13'),
(12, 9, 50, 'Walk In Interview', 'lamongan', NULL, '2025-11-13', '18:33:00', NULL, 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-11-23 23:33:36', '2025-11-23 23:33:36'),
(13, 9, 51, 'Walk In Interview', 'lamongan', NULL, '2025-11-11', '16:04:00', NULL, 'terjadwal', 'Terkirim', NULL, 'Axr6kH8eUazeY6WurYKTDpMjb30hcL9FoCm5Dobs', '2025-12-01 02:42:50', '2025-11-24 00:04:03', '2025-11-24 02:42:50'),
(16, 21, 51, 'Walk In Interview', 'lamongan', NULL, '2025-11-26', '18:12:00', NULL, 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-11-24 00:12:58', '2025-11-24 00:12:58'),
(18, 22, 49, 'Virtual Interview', NULL, 'https://youtube.com/', '2025-11-27', '15:00:00', NULL, 'terjadwal', 'Belum Diisi', NULL, NULL, NULL, '2025-11-26 23:43:50', '2025-11-26 23:43:50');
...
CREATE TABLE `lamaran` (
  ...
  `surat_lamaran_path` varchar(255) DEFAULT NULL,
  `resume_path` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `surat_lamaran_text` text DEFAULT NULL,
  `gaji_diharapkan` varchar(255) DEFAULT NULL,
  `pendidikan_terakhir` varchar(255) DEFAULT NULL,
  `pengalaman_tahun` int(11) DEFAULT NULL,
  `riwayat_karir` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`riwayat_karir`)),
  `deskripsi_kemampuan` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `lamaran` (`id`, `pelamar_id`, `lowongan_id`, `status`, `surat_lamaran_path`, `resume_path`, `created_at`, `updated_at`, `surat_lamaran_text`, `gaji_diharapkan`, `pendidikan_terakhir`, `pengalaman_tahun`, `riwayat_karir`, `deskripsi_kemampuan`) VALUES
(1, 38, 5, 'pending', NULL, NULL, '2025-08-07 13:24:05', '2025-08-07 13:24:05', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 51, 8, 'pending', NULL, NULL, '2025-08-21 11:30:44', '2025-08-21 11:30:44', NULL, NULL, NULL, NULL, NULL, NULL),
(5, 51, 5, 'pending', NULL, NULL, '2025-09-01 14:40:38', '2025-09-01 14:40:38', NULL, NULL, NULL, NULL, NULL, NULL),
(6, 51, 9, 'pending', NULL, NULL, '2025-09-03 19:24:34', '2025-09-03 19:24:34', NULL, NULL, NULL, NULL, NULL, NULL),
(7, 53, 8, 'pending', NULL, NULL, '2025-09-04 05:45:07', '2025-09-04 05:45:07', NULL, NULL, NULL, NULL, NULL, NULL),
(8, 55, 9, 'pending', NULL, NULL, '2025-09-18 00:47:16', '2025-09-18 00:47:16', NULL, NULL, NULL, NULL, NULL, NULL),
(9, 55, 5, 'pending', NULL, NULL, '2025-09-21 01:55:35', '2025-09-21 01:55:35', NULL, NULL, NULL, NULL, NULL, NULL),
(10, 50, 11, 'pending', NULL, NULL, '2025-09-25 11:14:31', '2025-09-25 11:14:31', NULL, NULL, NULL, NULL, NULL, NULL),
(11, 51, 15, 'pending', NULL, NULL, '2025-09-27 00:29:55', '2025-09-27 00:29:55', NULL, NULL, NULL, NULL, NULL, NULL),
(12, 50, 9, 'pending', NULL, NULL, '2025-10-03 04:19:35', '2025-10-03 04:19:35', NULL, NULL, NULL, NULL, NULL, NULL),
(13, 51, 17, 'pending', NULL, NULL, '2025-11-23 03:08:26', '2025-11-23 03:08:26', NULL, NULL, NULL, NULL, NULL, NULL),
(14, 10, 17, 'pending', NULL, NULL, '2025-11-23 07:14:33', '2025-11-23 07:14:33', NULL, NULL, NULL, NULL, NULL, NULL),
(15, 55, 17, 'pending', NULL, NULL, '2025-11-23 07:20:53', '2025-11-23 07:20:53', NULL, NULL, NULL, NULL, NULL, NULL),
(16, 51, 16, 'pending', NULL, NULL, '2025-11-23 07:31:31', '2025-11-23 07:31:31', NULL, NULL, NULL, NULL, NULL, NULL),
(17, 10, 16, 'pending', NULL, NULL, '2025-11-23 20:19:55', '2025-11-23 20:19:55', NULL, NULL, NULL, NULL, NULL, NULL),
(18, 56, 16, 'pending', NULL, NULL, '2025-11-23 21:47:50', '2025-11-23 21:47:50', NULL, NULL, NULL, NULL, NULL, NULL),
(19, 56, 17, 'pending', NULL, NULL, '2025-11-23 22:33:16', '2025-11-23 22:33:16', NULL, NULL, NULL, NULL, NULL, NULL),
(20, 56, 8, 'pending', NULL, NULL, '2025-11-23 22:42:57', '2025-11-23 22:42:57', NULL, NULL, NULL, NULL, NULL, NULL),
(21, 56, 5, 'pending', 'surat_lamaran/nOl42pEQtnyjwDw95OP93sD5hsfOoX38M7esqvZy.png', NULL, '2025-11-23 23:03:38', '2025-11-23 23:03:38', NULL, NULL, 'S1', 3, '{\"mulai\": \"2023-06-06\", \"posisi\": \"Developer\", \"berakhir\": \"2025-09-15\", \"perusahaan\": \"RAquaticus\"}', NULL),
(22, 51, 11, 'pending', 'surat_lamaran/L8iN3QSPwN0p5PBcAHeuVwHjA2ZkBid1pvLmRkiE.png', 'resume/pEM4uuHCunmlCVESZzaXz5DgSjJ12bfcoS3C8Jo1.png', '2025-11-23 23:06:55', '2025-11-23 23:06:55', NULL, NULL, 'SMA/SMK Sederajat', 3, '{\"mulai\": \"2023-06-06\", \"posisi\": \"Developer\", \"berakhir\": \"2025-09-15\", \"perusahaan\": \"RAquaticus\"}', NULL),
(23, 51, 21, 'pending', NULL, NULL, '2025-11-24 00:07:25', '2025-11-24 00:07:25', NULL, NULL, 'SMA/SMK Sederajat', 2, '{\"posisi\":\"ceo\",\"perusahaan\":\"RAquaticus\",\"mulai\":\"2025-11-20\",\"berakhir\":\"2025-11-28\"}', NULL),
(24, 10, 20, 'pending', NULL, NULL, '2025-11-24 00:09:14', '2025-11-24 00:09:14', NULL, NULL, 'SMA/SMK Sederajat', 2, '{\"posisi\":\"ceo\",\"perusahaan\":\"RAquaticus\",\"mulai\":\"2025-11-26\",\"berakhir\":\"2025-11-26\"}', NULL),
(26, 49, 22, 'diterima', 'surat_lamaran/kI3SulzCSeoFGDAIrIm9IjHtcFJiSdzfesZwNU8d.jpg', 'resume/0MZyyhbL6ZnYL9caiRdRnyudgaJMsyD6PaJRivtz.png', '2025-11-26 13:32:11', '2025-11-26 23:51:50', NULL, NULL, 'SMA/SMK Sederajat', 2, '{\"posisi\":\"Penyiar\",\"perusahaan\":null,\"mulai\":null,\"berakhir\":null}', NULL),
(27, 49, 23, 'dilihat', 'surat_lamaran/VZ2i7uGZ5OIclrj7dHGpRA5tHiEX3uPl73hWqU1g.jpg', 'resume/7yFkaKh9a8yen1I1fjAOje6iwMutYYRSWKhpQJd9.webp', '2025-11-27 00:12:08', '2025-11-27 00:12:50', NULL, NULL, 'SMA/SMK Sederajat', 1, '{\"posisi\":\"sales marketing honda\",\"perusahaan\":\"PT ahass\",\"mulai\":\"2023-03-08\",\"berakhir\":\"2025-11-12\"}', NULL);
...
(22, 13, 'Penyiar Radio', 'Semarang', 'Full-time', 'siap melakukan siaran radio pada shift pagi dan malam, pembagian shift akan dibagi oleh...', NULL, 'Semua', 'S1', NULL, 21, '3.00', '1', 5, NULL, 'standar', 20, 16, 16, 16, 16, 16, 0, 1, '2025-11-26 13:29:39', '2025-11-26 13:29:39'),
(23, 13, 'Sales Marketing Jasa Komunikasi', 'Yogyakarta', 'Full-time', 'Membutuhkan tim untuk mengisi sales yang siap ditempatkan di yogyakarta atau untuk domisili yogyakarta mendapat point plus', NULL, 'Perempuan', 'SMA/SMK', NULL, 20, '85.00', '1', 5, NULL, 'standar', 40, 12, 12, 12, 12, 12, 0, 1, '2025-11-27 00:09:01', '2025-11-27 00:09:01');
...
(23, 49, 5, '2025-11-27 14:34:15', '2025-11-27 14:34:15'),
(24, 49, 6, '2025-11-27 14:34:19', '2025-11-27 14:34:19'),
(25, 49, 8, '2025-11-27 14:34:21', '2025-11-27 14:34:21'),
(26, 49, 15, '2025-11-27 14:42:47', '2025-11-27 14:42:47'),
(27, 49, 23, '2025-11-27 14:51:23', '2025-11-27 14:51:23');
...
('0e917274-8daa-4682-baf3-77e7d09ca091', 'App\\Notifications\\PelamarBaruNotification', 'App\\Models\\User', 76, '{\"lamaran_id\":24,\"nama_pelamar\":\"akmal\",\"lowongan_id\":20,\"judul_lowongan\":\"AKUNTANSI DASAR\",\"message\":\"akmal telah melamar untuk posisi AKUNTANSI DASAR.\"}', NULL, '2025-11-24 00:09:15', '2025-11-24 00:09:15'),
('245db4ec-0871-4d01-b993-4bcd4eab120d', 'App\\Notifications\\PelamarBaruNotification', 'App\\Models\\User', 76, '{\"lamaran_id\":13,\"nama_pelamar\":\"akmal\",\"lowongan_id\":10,\"judul_lowongan\":\"karyawan service\",\"message\":\"akmal telah melamar untuk posisi karyawan service.\"}', NULL, '2025-11-23 21:21:53', '2025-11-23 21:21:53'),
...
('3e4fbd4a-835c-4c27-a945-bfdf23192cbb', 'App\\Notifications\\PelamarBaruNotification', 'App\\Models\\User', 86, '{\"type\":\"new_application\",\"lamaran_id\":26,\"nama_pelamar\":\"dutaedan\",\"lowongan_id\":22,\"judul_lowongan\":\"Penyiar Radio\",\"message\":\"dutaedan telah melamar untuk posisi Penyiar Radio.\"}', NULL, '2025-11-26 13:32:11', '2025-11-26 13:32:11'),
...
('b1f80cae-c463-47e3-854c-71a93b8478d8', 'App\\Notifications\\PelamarBaruNotification', 'App\\Models\\User', 76, '{\"lamaran_id\":23,\"nama_pelamar\":\"Rizqi Aditia Maulana\",\"lowongan_id\":21,\"judul_lowongan\":\"pppp\",\"message\":\"Rizqi Aditia Maulana telah melamar untuk posisi pppp.\"}', NULL, '2025-11-24 00:07:25', '2025-11-24 00:07:25'),
...
('e3824703-fbab-4ac4-9894-dc9021b42a08', 'App\\Notifications\\PelamarBaruNotification', 'App\\Models\\User', 76, '{\"type\":\"new_application\",\"lamaran_id\":25,\"nama_pelamar\":\"dutaedan\",\"lowongan_id\":21,\"judul_lowongan\":\"pppp\",\"message\":\"dutaedan telah melamar untuk posisi pppp.\"}', NULL, '2025-11-25 08:47:12', '2025-11-25 08:47:12'),
('f0fe8a4e-21ec-461b-926b-4fcb0fe4b590', 'App\\Notifications\\PelamarBaruNotification', 'App\\Models\\User', 86, '{\"type\":\"new_application\",\"lamaran_id\":27,\"nama_pelamar\":\"dutaedan gantang\",\"lowongan_id\":23,\"judul_lowongan\":\"Sales Marketing Jasa Komunikasi\",\"message\":\"dutaedan gantang telah melamar untuk posisi Sales Marketing Jasa Komunikasi.\"}', NULL, '2025-11-27 00:12:08', '2025-11-27 00:12:08'),
...
(49, 71, 'dutaedan gantang', 'avatars/ndtPqm0miLxC6hfdtHjH06fcDwuzLGCXPyQGZGkr.png', '2345671829384666', 'Jalan Lanan 1465', 'Demak', 'SMA/SMK Sederajat', '082328872084', '2004-03-20', 'Laki-laki', '2023', 85.50, '1-3 Tahun', 0, NULL, 'ktp/kuWJeg4G9JVabaC7026zldGp70cy8b3bBDYOzWMG.png', '2025-08-19 03:59:57', '2025-11-26 14:30:34'),
...
(52, 77, 'Rizqi Aditia Maulana', 'avatars/DLGeSv9CzRNhdQlOFT5W2R5p8kr5fztP68fSKLX8.jpg', '3321219873816638', 'Jalan Lanan 1465, Plamongansari', 'Semarang', 'S1', '081342648421', '2000-02-21', 'Laki-laki', '2025', 3.60, '3-5 Tahun', 0, NULL, 'ktp/Ac3fAb6BfhhhlFynrm8KrJtX5H0dxyxo4FVMqEKW.png', '2025-08-28 09:23:18', '2025-11-26 14:11:29'),
...
(59, 84, 'pppp', NULL, '2345671829381115', 'Girikusumo', 'Demak', 'SMP/Sederajat', '08128937465', '2022-06-07', 'Laki-laki', '2025', 78.88, '1-3 Tahun', 0, NULL, NULL, '2025-11-24 00:15:04', '2025-11-24 00:15:04');
...
(13, 86, 'PT. DutaAbadi', 'Jalan Lanan 1465', 'Semarang', '50193', '089504447020', '123456789101112', NULL, 'Perusahaan yang bergerak dibidang ilmu komunikasi yang saat ini melakukan siaran berita di frekuensi 96.10mhz', 'logos/Zieodv2uPLyMb3JosMsAAR9b58SzCx0SSIu26npj.png', 0, '2025-11-26 13:23:50', '2025-11-26 13:26:14');
...
('kTekU7BaCyu6oNnX45moLIdfv9vpERVOzX6wPqnm', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36 Edg/142.0.0.0', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiT2JBNWlJNkpvaE44ZEVZTlF2RzlNVXAwN3RBbFgwMTVrSTRzd29GeSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fX0=', 1764280319);
...
--
-- Dumping data for table `undangan_lamaran`
--

INSERT INTO `undangan_lamaran` (`id`, `perusahaan_id`, `pelamar_id`, `lowongan_id`, `status`, `pesan`, `created_at`, `updated_at`) VALUES
(1, 13, 52, 22, 'dilihat', 'halo joinlah', '2025-11-26 14:13:01', '2025-11-26 14:20:31');
...
(71, 'dutaedan gantang', 'dutaarryaduta98@gmail.com', '2025-08-19 04:00:15', '$2y$12$VBIAINovZLk4JsYskK0.9OBr3fFcl0sfS9U4lt0y7pyKCUaSrT59i', NULL, NULL, 'pelamar', NULL, '2025-08-19 03:59:57', '2025-11-26 14:30:34'),
...
(84, 'pppp', '223220034@student.unaki.ac.id', '2025-11-24 00:15:21', '$2y$12$E2krDq6qkqwBhkKfOr70qe6/AVCyLKnY78b8E3SjBOkuAG/0Isiwe', NULL, NULL, 'pelamar', NULL, '2025-11-24 00:15:04', '2025-11-24 00:15:21'),
(85, 'si Rodriguez', 'dutarodriguez202@gmail.com', NULL, '$2y$12$u3DccAAAbMf9ER2Tw5t1deNpJi8H3BFHPOekicXOiwDcHzp5c2vRO', NULL, NULL, 'pelamar', NULL, '2025-11-26 13:21:24', '2025-11-26 13:21:24'),
(86, 'PT. DutaAbadi', '223210044@student.unaki.ac.id', '2025-11-26 13:24:59', '$2y$12$BgR82f6H9S55wk88A0T5UO9SEohEKk0I.b8hnJiqouF7OoRvFprKO', NULL, NULL, 'perusahaan', NULL, '2025-11-26 13:23:50', '2025-11-26 13:24:59');
...
--
-- Indexes for table `form_isian_interview`
--
ALTER TABLE `form_isian_interview`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `form_isian_interview_jadwal_id_unique` (`jadwal_id`),
  ADD KEY `form_isian_interview_pelamar_id_foreign` (`pelamar_id`);
...
ALTER TABLE `jadwal_wawancara`
  ...
  ADD KEY `jadwal_wawancara_form_submission_id_foreign` (`form_submission_id`);
...
--
-- AUTO_INCREMENT for table `form_isian_interview`
--
ALTER TABLE `form_isian_interview`
...
--
-- Constraints for table `form_isian_interview`
--
ALTER TABLE `form_isian_interview`
  ADD CONSTRAINT `form_isian_interview_jadwal_id_foreign` FOREIGN KEY (`jadwal_id`) REFERENCES `jadwal_wawancara` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `form_isian_interview_pelamar_id_foreign` FOREIGN KEY (`pelamar_id`) REFERENCES `profiles_pelamar` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `jadwal_wawancara`
  ADD CONSTRAINT `jadwal_wawancara_form_submission_id_foreign` FOREIGN KEY (`form_submission_id`) REFERENCES `form_isian_interview` (`id`) ON DELETE SET NULL,
